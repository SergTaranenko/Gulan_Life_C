...
RANK = {
    ...
    "hunger_warning_text": (
        "⚠️ Шакалы уже обнюхивают твою яму. {hours:.0f} ч. без дела — "
        "ты становишься приманкой, {rank_name}."
    ),
    "hunger_riot_text": (
        "🔥 {hours:.0f} ч. без дела. Стая шакалов кружит ближе, чем вчера. "
        "Двигайся, {rank_name}, или станешь обедом."
    ),
